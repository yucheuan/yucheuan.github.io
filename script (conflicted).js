...
if(document.getElementById('phaseOneV1').played){
    console.log("OK");
    document.getElementsByClassName('videox.active.autoVid').playbackRate=2.0;
}
...
video.addEventListener('timeupdate', function(event) {
    ...
    if (currentTime > 1 && animationTrigger === true) {
        animationTrigger = true;
        // Fire the hightlight animation
    }
